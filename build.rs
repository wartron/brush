...
fn main() -> Result<()> {
    WgslBindgenOptionBuilder::default()
        ...
        .add_entry_point("src/splat_render/shaders/map_tile_bounds.wgsl")
        .add_entry_point("src/splat_render/shaders/map_tile_skipset.wgsl")
        .add_entry_point("src/splat_render/shaders/rasterize_skipset.wgsl")

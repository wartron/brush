    ...
    fn update(&mut self, ctx: &egui::Context, frame: &mut eframe::Frame) {
        ...
        egui::SidePanel::left("Data").show(ctx, |ui| {
            ...
            ui.collapsing("Download", |ui| {
                ui.hyperlink_to("MacOS", "https://www.google.com/");
                ui.hyperlink_to("Windows", "https://www.google.com/");
            });

            ui.heading("Example Data");

            ui.collapsing("Polycam examples", |ui| {
                ui.label("Examples from poylcam showcase. Nb: Licenses apply, demo only!");

                ui.hyperlink_to("city_sector (250MB)", "https://drive.google.com/file/d/12yoAvwsUh1TNRt4I1rfTxyRp-_6p0x0b/view?usp=sharing");
                ui.hyperlink_to("flowers (120MB)", "https://drive.google.com/file/d/1KD_IP-Qt782guD1PvNATQrJGM0kxIhGa/view?usp=sharing");
                ui.hyperlink_to("fountain (340MB)", "https://drive.google.com/file/d/13mQfEoSNy-hOh5Ir9NuHLgtj6JA6aL4d/view?usp=sharing");
                ui.hyperlink_to("hollywood sign (320MB)", "https://drive.google.com/file/d/1bZfsNe5DVVgq2FM49e7StRKcnKVrvAma/view?usp=sharing"); 
                ui.hyperlink_to("inveraray castle (300MB)", "https://drive.google.com/file/d/1EOir_xBPE9Ns5CToEw_eAINGNHg5mA1F/view?usp=sharing");
                ui.hyperlink_to("lighthouse (70MB)", "https://drive.google.com/file/d/1f_ZCp04wax_aD6M699zg8wlWmiMU2EFQ/view?usp=sharing");
                ui.hyperlink_to("room arch vis (160MB)", "https://drive.google.com/file/d/1wi6B-6fPn2cQuGiucg_AMvVW623-reEF/view?usp=sharing");
                ui.hyperlink_to("small bonsai (135MB)", "https://drive.google.com/file/d/1wXiW9vn32DXG7NP0MsBQP4E8RF4M8nV-/view?usp=sharing");
                ui.hyperlink_to("varenna (200MB)", "https://drive.google.com/file/d/1lvljIKlMjVSRjy4KfPhbRSjN8t6KJYM9/view?usp=sharing");
            });

            ui.collapsing("Mipnerf scenes (warning: big)", |ui| {
                ui.label("Reference mipnerf ply files.");
                ui.hyperlink_to("bicycle (1.4GB)", "https://drive.google.com/file/d/1kHkNqGFLLutRt3R7k2tGkjGwfXnPLnCi/view?usp=sharing");
                ui.hyperlink_to("bonsai (300MB)", "https://drive.google.com/file/d/1jf4bjaeTGeru1PQS_Ue716uc_edRbAPd/view?usp=sharing");
                ui.hyperlink_to("counter (290MB)", "https://drive.google.com/file/d/1O89SIHcWdmrWi75Cf6tDrv2Dl6yGndcz/view?usp=sharing");
                ui.hyperlink_to("drjohnson (800MB)", "https://drive.google.com/file/d/13FEQ7UZHYwymBTwxzpPeJob4cr8VxUTV/view?usp=sharing");
                ui.hyperlink_to("garden (1.3GB)", "https://drive.google.com/file/d/13FEQ7UZHYwymBTwxzpPeJob4cr8VxUTV/view?usp=sharing");
                ui.hyperlink_to("kitchen (440MB)", "https://drive.google.com/file/d/13FEQ7UZHYwymBTwxzpPeJob4cr8VxUTV/view?usp=sharing");
                ui.hyperlink_to("playroom (600MB)", "https://drive.google.com/file/d/13FEQ7UZHYwymBTwxzpPeJob4cr8VxUTV/view?usp=sharing");
                ui.hyperlink_to("room (375MB)", "https://drive.google.com/file/d/13FEQ7UZHYwymBTwxzpPeJob4cr8VxUTV/view?usp=sharing");
                ui.hyperlink_to("stump (1.15GB)", "https://drive.google.com/file/d/13FEQ7UZHYwymBTwxzpPeJob4cr8VxUTV/view?usp=sharing");
            });

            ui.collapsing("Train blender scenes", |ui| {
                ui.hyperlink_to("Chair", "https://drive.google.com/file/d/13Q6s0agTW1_a7cFGcSmll1-Aikq_OPKe/view?usp=sharing");
                ui.hyperlink_to("Drums", "https://drive.google.com/file/d/1j8TuMiGb84YtlrZ0gnkMNOzUaIJqz0SY/view?usp=sharing");
                ui.hyperlink_to("Ficus", "https://drive.google.com/file/d/1VzT5SDiBefn9fvRw7LeYjUfDBZHCyzQ4/view?usp=sharing");
                ui.hyperlink_to("Hotdog", "https://drive.google.com/file/d/1hOjnCV8XdXClV2eC6c9H6PIQTUYv8zys/view?usp=sharing");
                ui.hyperlink_to("Lego", "https://drive.google.com/file/d/1VxsNFTHhgxK9iCOgkuKxakBXJfgHUOQk/view?usp=sharing");
                ui.hyperlink_to("Materials", "https://drive.google.com/file/d/1L7J5PNBcLcXde6CqzzkaNxHt7JtG2GIW/view?usp=sharing");
                ui.hyperlink_to("Mic", "https://drive.google.com/file/d/1SA0NNi0HsUHE6FgAP8XpD23N1xftsrr-/view?usp=sharing");
                ui.hyperlink_to("Ship", "https://drive.google.com/file/d/1rzL0KrWuLFebT1hLLm4uYnrNXNTkfjxM/view?usp=sharing");
            });
        });
